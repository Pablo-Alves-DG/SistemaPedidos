...
<script src="JS/Menu.js"></script>
    <section>
        <div id="tabela" class="box">
            ...
            $sql = "Select Distinct Limite_Expedicao, Num_Auto_Remessa, Data_Entrega, Cliente, Cliente_DN4, Pedido, Termo, Chamado_Comercial from Tab_Pos_Expedicao where Saldo <>'0' and Status = 'Expedido' order by Data_Entrega desc";
    ...
    <form id="formtemp" style="display: none" action="Entrega2_Expedido.php" method="post">
