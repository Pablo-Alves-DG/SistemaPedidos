...
<script src="JS/Menu.js"></script>
    ...
    <form style="display: none;" id="formtemp" action="PHP/saida_separacao.php" method="post">
        <table id="tabtemp">
            <tbody>
                <tr></tr>
            </tbody>
