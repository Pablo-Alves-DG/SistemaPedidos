...
<script src="JS/Menu.js"></script>
    <section>
        <div id="tabela" class="box">
            <table class="tabela">
                <thead>
                    <tr>
                        ...
                        <th>&nbsp;Pedido&nbsp;</th>
                        <th>&nbsp;Termo&nbsp;</th>
                        <th>&emsp;Chamado&emsp;<br>&emsp;Comercial&emsp;</th>
            ...
            $sql = "Select Distinct Limite_Expedicao, Num_Auto_Remessa, Data_Entrega, Cliente, Cliente_DN4, Pedido, Termo, Chamado_Comercial from Tab_Emissao_NF where Saldo <>'0' order by Data_Entrega desc";
    ...
    <form id="formtemp" style="display: none" action="Emissao_NF2.php" method="post">
