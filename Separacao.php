...
<script src="JS/Menu.js"></script>
    <section>
        <div id="tabela" class="box">
            ...
            $sql = "Select Distinct Limite_Expedicao, Num_Auto_Remessa, Data_Entrega, Cliente, Cliente_DN4, Pedido, Termo, Chamado_Comercial from Tab_Separacao where Saldo <>'0' order by Data_Entrega desc";
    ...
    <form id="formtemp" style="display: none" action="separacao2.php" method="post">
