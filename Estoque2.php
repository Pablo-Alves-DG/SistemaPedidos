...
<script src="JS/Menu.js"></script>
    <div id="tabela" class="box">
        <table onchange="uptable()" id="dados" class="tabela">
            <thead>
                <tr>
            ...
            $sql = "Select Num_Auto_Remessa, Observacao, Data_Criacao, Tipo_Item, Item, Saldo from Tab_Estoque where Cliente = '" . $_POST['Cliente'] . "' and Cliente_DN4 = '" . $_POST['Cliente_DN4'] . "' and Pedido = '" . $_POST['Pedido'] . "' and Termo = '" . $_POST['Termo'] . "' and Chamado_Comercial = '" . $_POST['Chamado_Comercial'] . "' and Num_Auto_Remessa = '" . $_POST['Num_Auto_Remessa'] . "' and Data_Entrega = '" . $_POST['Data_Entrega'] . "' order by Item";
            ...
            while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                ...
                echo "<tr>
                    ...
                    <td>
                    <select class='Status_Unico' id='Status[" . $li . "]'>" . "<option value='Ag_Separacao'>Ag. Separação</option>
                                                          <option value='Ag_Alt_Comercial'>Ag. Alteração do Comercial </option>
                                                          <option value='Ag_Compras'>Ag. Compras</option>" . 
                    "</select>
                </td>
                </tr>";
                $li = $li +1;
    ...
    <div onchange="uptable()" id="tabela2" class="box">
        <table class="tabela2">
            <tbody>
                <tr>
                ...
                <tr>
                    <th>Data do estoque: <input id="data_estoque" type="datetime-local" name="item" size="25"></th>
                </tr>
                <tr>
                    <th>Número da Remessa: <input id="numero_remessa" type="text" name="numero_remessa" size="25"></th>
                </tr>
                <tr style="display: none;" id="tr_numero_remessa">
                    <th>Número da Solicitação <br> de Compras:</th> <th><input id="numero_remessa" type="text" name="numero_remessa" size="25"></th>
                </tr>
                <tr>
                    <th>Status Todos:</th>
                </tr>
                <th>
                    <select disabled="true" id="status_todos" name="estrategia">
                        <option value='Ag_Separacao'>Ag. Separação</option>
                        <option value="Ag_Alt_Comercial">Ag. Alteração do Comercial </option>
                        <option value="Ag_Compras">Ag.Compras </option>
                    </select>
                </th>
                <tr>
                    <th><button id="enviar" onclick="enviar()">adicionar</button></th>
                </tr>
            </tbody>
        </table>
    </div>
    <form style="display: none;" id="formtemp" action="PHP/saida_estoque.php" method="post">
        <table id="tabtemp">
            <tbody>
                <tr></tr>
            </tbody>
    ...
    <script>
        function uptable(){
            ...
            for (var ref = 0, linha; linha = dados.rows[ref]; ref++){
                ...
                if (status == "Ag_Compras"){document.getElementById("tr_numero_remessa").setAttribute("style","Display: table-cell"); break;}
                else{document.getElementById("tr_numero_remessa").setAttribute("style","Display: none");}
                li++;
            }
        }
        ...
        function enviar() {
            ...
            for (var ref = 0, linha; linha = dados.rows[ref]; ref++) {
                ...
                t9.innerHTML = "<input id='Data_Estoque[" + li + "]' type='text' name='Data_Estoque[" + li + "]' value='" + document.getElementById('data_estoque').value + "'>";
                ...
                t16.innerHTML = "<input id='Numero_Remessa[" + li + "]' type='text' name='Numero_Remessa[" + li + "]' value='" + document.getElementById("numero_remessa").value + "'>";
                li++;
            }
        ...
        function datenow() {
            var data = new Date();
            document.getElementById('data_estoque').value = data.getFullYear() + '-' + ('0' + (data.getMonth() + 1)).slice(-2) + '-' + ('0' + data.getDate()).slice(-2) + 'T' + ('0' + data.getHours()).slice(-2) + ':' + ('0' + data.getMinutes()).slice(-2);
        }
    </script>
</body>
