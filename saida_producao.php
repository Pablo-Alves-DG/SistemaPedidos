...
$Data_Producao = date('Y-m-d H:i:s',strtotime($_POST['Data_Producao'][$ini]));
...
/////////////////////////// Atualização de Tabela Producao////////////////////////

//SQL de Consulta para Somar QTD_Enviadas
$sqlqe = "Select Quantidade_Saida, Saldo from Tab_Producao 
where
Cliente = '{$Cliente}' and 
Cliente_DN4 = '{$Cliente_DN4}' and 
Pedido = '{$Pedido}' and 
