...
$Data_Estoque = date('Y-m-d H:i:s',strtotime($_POST['Data_Estoque'][$ini]));
...
/////////////////////////// Atualização de Tabela Separacao////////////////////////

//SQL de Consulta para Somar QTD_Enviadas
$sqlqe = "Select Quantidade_Saida, Saldo from Tab_Emissao_NF 
where
Cliente = '{$Cliente}' and 
Cliente_DN4 = '{$Cliente_DN4}' and 
Pedido = '{$Pedido}' and 
...
//SQL de Update
$sqlup = "UPDATE [dbo].[Tab_Emissao_NF]
SET 
   [Quantidade_Saida] = ?
   ,[Saldo] = ?
   where 
...
header("Location: ../Emissao_NF.php");
exit();
