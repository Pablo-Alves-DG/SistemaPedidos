...
<script src="JS/Menu.js"></script>
        ...
        <table id="dados" class="tabela">
            ...
            while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                ...
                echo "<tr>
                    ...
                    <td>
                    <select class='Status_Unico' id='Status[" . $li . "]'>" . "<option value='Ag_Producao'>Ag. Produção</option>
                                                          <option value='Ag_Expedicao'>Ag. Expedição</option>
                                                          <option value='Ag_Compras'>Ag. Compras</option>
                                                          <option value='Ag_Estoque'>Ag. Estoque</option>" . 
                    "</select>
                </td>
                </tr>";
                $li = $li +1;
            ...
            <tbody>
                ...
                <th>
                    <select disabled="true" id="status_todos" name="estrategia">
                        <option value="Ag_Producao">Ag.Produção</option>
                        <option value="Ag_Expedicao">Ag.Expedição</option>
                        <option value="Ag_Compras">Ag.Compras </option>
                        <option value="Ag_Estoque">Ag.Estoque </option>
                    </select>
    ...
    <form style="display: none;" id="formtemp" action="PHP/saida_emissao_nf.php" method="post">
        <table id="tabtemp">
            <tbody>
                <tr></tr>
            </tbody>
    ...
    <script>
        function enviar() {
            ...
            for (var ref = 0, linha; linha = dados.rows[ref]; ref++) {
                ...
                var t14 = add.insertCell(12);
                var t15 = add.insertCell(12);
