    ...
    <script>
        function enviar() {
            ...
            for (var ref = 0, linha; linha = dados.rows[ref]; ref++) {
                ...
                t16.innerHTML = "<input id='Status_Antigo[" + li + "]' type='text' name='Status_Antigo[" + li + "]' value='" + "Entregue" + "'>";
                li++;
            }
