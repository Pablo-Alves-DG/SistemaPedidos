...
<script src="JS/Menu.js"></script>
    ...
    <div id="tabela2" class="box">
        <table class="tabela2">
            <tbody>
                ...
                <tr>
                    <th>Data da Expedição: <input id="data_expedicao" type="datetime-local" name="item" size="25"></th>
                </tr>
                <tr>
                    <th>Status Todos:</th>
                </tr>
    ...
    <form style="display: none;" id="formtemp" action="PHP/saida_expedicao.php" method="post">
        <table id="tabtemp">
            <tbody>
                <tr></tr>
            </tbody>
    ...
    <script>
        function enviar() {
            ...
            for (var ref = 0, linha; linha = dados.rows[ref]; ref++) {
                ...
                t9.innerHTML = "<input id='Data_Expedicao[" + li + "]' type='text' name='Data_Expedicao[" + li + "]' value='" + document.getElementById('data_expedicao').value + "'>";
                ...
                t16.innerHTML = "<input id='NF[" + li + "]' type='text' name='NF[" + li + "]' value='" + document.getElementById("NF").value + "'>";
                li++;
            }
        ...
        function datenow() {
            var data = new Date();
            document.getElementById('data_expedicao').value = data.getFullYear() + '-' + ('0' + (data.getMonth() + 1)).slice(-2) + '-' + ('0' + data.getDate()).slice(-2) + 'T' + ('0' + data.getHours()).slice(-2) + ':' + ('0' + data.getMinutes()).slice(-2);
        }
    </script>
</body>
