...
$Status_Antigo = $_POST['Status_Antigo'][$ini];
$Data_Status = date('Y-m-d H:i:s',strtotime($_POST['Data_Status'][$ini]));
...
$sqlcon = "Select Item, Quantidade_Entrada, Saldo  From Tab_Pos_Expedicao where
...
//SQL Básico
$sql = "INSERT INTO [dbo].[Tab_Pos_Expedicao]
([Num_Auto_Remessa]
,[Ultima_Data_Expedicao]
,[Data_Ultimo_Movimento]
,[Data_Criacao]
...
$sqlqe = "Select Quantidade_Saida, Saldo from Tab_Pos_Expedicao 
where
Cliente = '{$Cliente}' and 
Cliente_DN4 = '{$Cliente_DN4}' and 
Pedido = '{$Pedido}' and 
...
//SQL de Update
$sqlup = "UPDATE [dbo].[Tab_Pos_Expedicao]
SET 
   [Quantidade_Saida] = ?
   ,[Saldo] = ?
   where 
...
header("Location: ../Entrega_{$Status_Antigo}.php");
exit();
